...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  '检验',
                nextQuestionText: '下一题 <i class="fa fa-chevron-right"></i>',
                backButtonText: '<i class="fa fa-chevron-left"></i> 上一题',
                completeQuizText: '交卷 <i class="fa fa-check-square-o"></i>',
                tryAgainText: '重做 <i class="fa fa-undo"></i>',
                questionCountText: '第 %current题，共 %total题',
                preventUnansweredText: '至少选择一个回答',
                questionTemplateText:  '[选择题] %count. %text',
                scoreTemplateText: '<span class=\"score\">%score</span>',
